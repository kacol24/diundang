        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-start">
                <small class="fst-italic">
                    You can <a href="{{ route('download', ['guest' => $invitation?->guest_code]) }}" target="_blank" style="var(--color-secondary)">download</a> this digital invitation, screenshot this page, or save the QR Code as image.
                </small>
            </div>
        </div>
    </div>
